            ...
            <footer className="p-10 bg-base-300 text-base-content mt-10">
                <div className='footer'>
                    <div>
                        ...
                        <Link className="link link-hover">Man</Link>
                        <Link className="link link-hover">Women</Link>
                        <Link className="link link-hover">Kids</Link>
                        <Link className="link link-hover">Advertisement</Link>
                    </div>
                    <div>
                        <span className="footer-title">Clothing Spark</span>
